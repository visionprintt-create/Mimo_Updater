...
import { signIn, signInWithGoogle, isAdmin, isLead } from '@/lib/auth';
import './login.css';
    ...
    <div className="login-wrapper">
      ...
      <div className="login-card">
        <div className="login-left">
          ...
          <div className="login-socials" style={{ width: '100%', marginBottom: '24px' }}>
            <button type="button" className="google-continue-btn" onClick={handleGoogleSignIn} disabled={emailLoading || googleLoading}>
              {googleLoading ? (
